            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>administrador/roles/store" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <label class="checkbox-inline"><input type="checkbox" name="total_access" id="total_access">Acceso a todas las funciones de todas las sucursales</label>
                            </div>
