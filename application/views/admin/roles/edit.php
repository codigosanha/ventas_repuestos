            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>administrador/roles/update" method="POST">
                            <input type="hidden" value="<?php echo $rol->id;?>" name="idRol">
                            <div class="form-group <?php echo form_error('nombre') == true ? 'has-error': '';?>">
                                <label for="nombre">Nombre:</label>
                                <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo set_value('nombre')?:$rol->nombre?>">
