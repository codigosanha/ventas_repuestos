...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <input type="hidden" id="modulo" value="backend/cuentas_cobrar">                
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <tbody>
                                    <?php if(!empty($cuentas_cobrar)):?>
                                        <?php foreach($cuentas_cobrar as $cuenta):?>
                                            <?php $venta = get_record("ventas","id=".$cuenta->venta_id);?>
                                            <tr>
...
<div class="modal fade" id="modal-abonar">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>backend/cuentas_cobrar/abonar" method="POST">
