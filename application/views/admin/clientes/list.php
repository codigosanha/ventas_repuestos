...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <input type="hidden" id="modulo" value="almacen/clientes">

                <div class="row">
                    <div class="col-md-12">
                        
                        <a href="<?php echo base_url();?>almacen/clientes/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar Clientes</a>
