                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>administrador/tipo_comprobantes/store" method="POST">
                            ...
                            <div class="form-group">
                                <label class="checkbox-inline"><input type="checkbox" name="total_access" id="total_access">Permitir la anulación de las ventas que poseen este tipo de comprobante</label>
                            </div>
                            <div class="form-group">
