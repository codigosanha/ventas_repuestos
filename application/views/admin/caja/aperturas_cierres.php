                            ...
                            <tbody>
                                <?php if(!empty($cajas)):?>
                                    <?php foreach($cajas as $caja):?>
                                        <tr>
                                            <td><?php echo get_record("usuarios","id=".$caja->usuario_id)->username;?></td>
                                            ...
                                            <td><?php echo get_record("sucursales","id=".$caja->sucursal_id)->nombre;?></td>
                                            <td>
                                                <div class="btn-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="monto_apertura" class="form-control" required="required">
        </div>
      </div>
...
<div class="modal fade" id="modal-corte">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger btn-cerrar-modal-vd pull-left" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary btn-print-cierre"><span class="fa fa-print"> </span>Imprimir</button>
      </div>
