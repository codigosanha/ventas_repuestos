                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>administrador/comprobantes/store" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="fecha_aprobacion_sat" name="fecha_aprobacion_sat">
                            </div>
                            <div class="form-group">
                                <label for="fecha_vencimiento_sat">Fecha Vencimiento SAT:</label>
                                <input type="date" class="form-control" id="fecha_vencimiento_sat" name="fecha_vencimiento_sat">
                            </div>
                            <div class="form-group">
