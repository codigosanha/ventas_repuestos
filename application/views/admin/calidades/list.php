...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <input type="hidden" id="modulo" value="almacen/calidades">
                <div class="row">
                    <div class="col-md-12">
                      
                        <a href="<?php echo base_url();?>almacen/calidades/add" class="btn btn-primary btn-flat"><span class="fa fa-plus"></span> Agregar Calidad</a>
                            ...
                            <tbody>
                                <?php if(!empty($calidades)):?>
                                    <?php foreach($calidades as $calidad):?>
                                        <tr>
                                            <td><?php echo $calidad->id;?></td>
                                            <td><?php echo $calidad->nombre;?></td>
                                            <td><?php echo $calidad->descripcion;?></td>
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-info btn-view" data-toggle="modal" data-target="#modal-default" value="<?php echo $calidad->id;?>">
