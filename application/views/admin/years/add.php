            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>almacen/years/store" method="POST">
                            <div class="form-group <?php echo form_error('year') == true ? 'has-error':''?>">
                                <label for="year">Año:</label>
                                <input type="text" class="form-control" id="year" name="year" value="<?php echo set_value('year')?:''?>" required="required">
